    ...
    <div>
      ...
      <main className="flex items-center flex-col">
        ...
        <section
          ...
          className="bg-slate-900 w-full py-20 sm:py-32"
        >
        ...
        <section
          id="pricing"
          className="border-t border-gray-200 relative rounded-3xl  mb-[100px] flex text-center items-center flex-col m-auto gap-[30px] px-10"
        >
