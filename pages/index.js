    ...
    <div>
      ...
      <main className="flex items-center flex-col">
        ...
        <section className="w-full bg-white p-9 md:mx-10  border-2 border-neutral-100 relative mt-[150px]  md:flex items-center flex-col m-auto ">
          ...
          <div className="flex flex-row-reverse max-w-screen-lg gap-20 m-auto">
            <div className="md:w-6/12 rounded-3xl border-solid border-2 border-neutral-100 overflow-hidden relative">
              <video
                className="video rounded-3xl"
                loop
            ...
            <div className="md:w-6/12 md:pl-8">
              <h2 className="lg:leading-none text-6xl md:block  text-slate-900 font-bold pt-10 md:pt-0 whitespace-pre-line font-serif">
        ...
        <section
          ...
          className="w-full relative overflow-hidden bg-tech py-20 sm:py-28"
        >
